...
<html lang="en">
   <head>
      ...
      <title>AMT Project 1 Albasini & Selimi </title>
   ...
   <body class="nav-md">
      <div class="container body" height="4000px">
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           <div class="x_content">
                              ...
                              <form class="form-horizontal form-label-left" novalidate method="post" action="login">

                                 <span class="section">Veuillez vous connecter</span>
